...
from transformers import (
    ...
    Trainer,
    TrainingArguments,
    set_seed, EvalPrediction, MistralForSequenceClassification, BitsAndBytesConfig, LlamaForSequenceClassification,
...
AUTOMODEL = {
    "mistralai": MistralForSequenceClassification,
    "meta-llama": LlamaForSequenceClassification,
    "google": GemmaForSequenceClassification
}
...
def compute_metrics(p: EvalPrediction, output_dir: str = None, step: int = None, epoch: float = None):
    ...
    results = {
        ...
        'precision': precision_score(y_true=p.label_ids, y_pred=preds, average=average, zero_division=0),
        'recall': recall_score(y_true=p.label_ids, y_pred=preds, average=average, zero_division=0),
        'f1': f1_score(y_true=p.label_ids, y_pred=preds, average=average, zero_division=0),
    }
