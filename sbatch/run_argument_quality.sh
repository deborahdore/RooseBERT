...
export WANDB_PROJECT="argument_quality"
      ...
      for batch in "${BATCH_SIZES[@]}"; do
        for epoch in "${EPOCHS[@]}"; do
          ...
          python src/run_classification.py \
            ...
            --train_file "./data/argument_quality/train.csv" \
            --validation_file "./data/argument_quality/dev.csv" \
            --test_file "./data/argument_quality/test.csv" \
            --eval_strategy "steps" \
            --eval_steps 1000 \
