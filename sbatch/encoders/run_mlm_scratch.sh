#!/bin/bash
#SBATCH --job-name=bert_base_uncased_scr_3e-4
#SBATCH -C a100
...
#SBATCH --output=logs/bert_base_uncased_scr_3e-4_%j.out
#SBATCH --error=logs/bert_base_uncased_scr_3e-4_%j.out
...
RUN_NAME="${MODEL_NAME}-scr-batch$((BATCH * N_GPUS * GRAD_ACC))-lr${LR}-SCRATCH"
