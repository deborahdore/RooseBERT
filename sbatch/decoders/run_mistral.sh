...
#SBATCH --output=logs/mistral.out
...
python src/fs_argument_detection.py --model_id "mistralai/Mistral-7B-Instruct-v0.3"
python src/fs_relation_classification.py --model_id "mistralai/Mistral-7B-Instruct-v0.3"
python src/fs_sentiment_analysis.py --model_id "mistralai/Mistral-7B-Instruct-v0.3"
python src/fs_stance_detection.py --model_id "mistralai/Mistral-7B-Instruct-v0.3"
...
python src/zs_stance_detection.py --model_id "mistralai/Mistral-7B-Instruct-v0.3"